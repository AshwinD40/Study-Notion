...
const CourseTable = ({courses, setCourses}) => {
  ...
  return (
    <div>
        <Table className=" border rounded border-richblack-800 ">
            <Thead>
                                    ...
                                    <div className="flex flex-col justify-between">
                                        ...
                                        </p>
                                        {
                                            course.status === COURSE_STATUS.DRAFT ? (
                                                <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-richblack-700 px-2 py-[2px] text-[12px] font-medium text-pink-100"><HiClock size={14} />
                                                Drafted</p>
                                            ) : (
