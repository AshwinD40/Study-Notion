    ...
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        ...
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12 ">
          ...
          <div className="flex flex-col gap-5 text lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                className="form-style px-4 py-2 bg-richblack-700 shadow-sm shadow-richblack-300 text-richblack-50 rounded-lg"
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <select
                ...
                name="gender"
                id="gender"
                className="form-style px-4 py-3 bg-richblack-700 shadow-sm shadow-richblack-300 text-richblack-50 rounded-lg"
