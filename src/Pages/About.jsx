      ...
      <section className='bg-richblack-800'>
        <div className=' relative flex w-11/12 mx-auto max-w-maxContent flex-col justify-between text-center text-white gap-10 '>
          ...
          <div className=' absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5 '>
            <img src={BannerImage1} alt="about us image 01" className=' rounded-md'/>
            <img src={BannerImage2} alt="about us image 02" className=' rounded-md'/>
            <img src={BannerImage3} alt="about us image 02"    className=' rounded-md' />
          </div>
        </div>
      </section>
